const translations = {
  ko: {
    ...
    deepP2: "따라서 <b>a</b>의 likelihood를 계산하려면 “어떤 시작 noise 또는 latent path가 <b>a</b>를 만들었는가?”뿐만 아니라, 그 변환 과정에서 확률밀도가 얼마나 압축되거나 팽창했는지도 알아야 한다.",
  ...
  en: {
    ...
    deepP2: "To compute the likelihood of <b>a</b>, we need to know not only which starting noise or latent path produced <b>a</b>, but also how much the transformation compressed or expanded probability density along the way.",
